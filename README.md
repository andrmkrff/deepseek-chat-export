...
### Скриншот:
![Интерфейс экспорта DeepSeek](https://raw.githubusercontent.com/andrmkrff/deepseek-chat-export/main/docs/images/photo_2026-01-01_02-25-56.jpg)
...
### Исправления:
- ✅ **Исправлено определение ролей** для DeepSeek Reasoner формата
- ✅ **Поддержка fragments.type** (REQUEST = пользователь, THINK/RESPONSE = ассистент)
- ✅ **Правильная статистика** сообщений по ролям
- ✅ **Улучшенное извлечение контента** из fragments